...
Esta información puede utilizarse para calcular la distancia entre el dispositivo emisor y el dispositivo receptor. Un ejemplo de ello puede verse en la imagen "Dispositivos emparejados y resultado BLE Scanner" siguiente:

![Dispositivos emparejados y resultado BLE Scanner](../img/microSM/BLE_scan.png)  

donde la aplicación BLE Scanner muestra las distancias reales de los dispositivos detectados.
