## <FONT COLOR=#007575>**Extensión BicroBlocks BLE**</font>
En la comunidad [MIT APP INVENTOR](https://community.appinventor.mit.edu/) podemos encontrar la entrada [MicroBlocks BLE Extension](https://community.appinventor.mit.edu/t/microblocks-ble-extension/129412) creada por [Peter Mathijssen](https://petermathijssen.nl/). En la misma se explica dicha extensión y se dan ejemplos de utilización.

Al final del artículo aparecen una serie de enlaces entre los que está la versión 1 de esta extensión, **MicroBlocks BLE Extension versión 1:**

* [fun.microblocks.microblocks.aix](https://community.appinventor.mit.edu/uploads/short-url/e7MefojXbpMYaVtviwWfAKe6x9V.aix)

!!! Danger ""
    !!! Info "IMPORTANTE:"
        Para poder descargar la extensión es necesario realizar un acceso identificado en la página web [MicroBlocks BLE Extension](https://community.appinventor.mit.edu/t/microblocks-ble-extension/129412).
